(custom-set-variables
 ...
 '(package-selected-packages
   '(zeal-at-point clj-deps-new org-tree-slide ox-asciidoc ob-kotlin
     ...
     wgrep multiple-cursors expand-region company rotate golden-ratio
     key-chord ace-window which-key ivy-rich counsel amx super-save esup
     command-log-mode helpful blackout use-package exec-path-from-shell)))
(custom-set-faces
